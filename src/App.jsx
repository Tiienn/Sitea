        ...
        <div className={`absolute right-3 z-30 flex flex-col items-end gap-2 animate-fade-in ${isReadOnly ? 'top-20' : 'top-12'}`}>
          ...
          {viewMode === 'firstPerson' && (
            <div className="flex flex-col items-end gap-1.5">
              ...
              {cameraMode === CAMERA_MODE.THIRD_PERSON && (
                <div className="panel-premium rounded-xl px-3 py-2 flex items-center gap-2">
                  <span className="text-[var(--color-text-muted)] text-[10px]">Near</span>
                  <input
                    type="range"
                    min={2}
                    max={15}
                    ...
                    className="w-24 h-5 accent-[var(--color-accent)]"
                  />
                  <span className="text-[var(--color-text-muted)] text-[10px]">Far</span>
                </div>
              )}
            </div>
          )}
