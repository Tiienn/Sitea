...
const Thumbnails = {
  ...
  mediumHouse: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#7CCD7C" />
      <rect x="6" y="6" width="28" height="28" rx="1" fill="#CD853F" stroke="#A0522D" strokeWidth="1" />
      <rect x="16" y="24" width="8" height="10" fill="#8B4513" />
      <rect x="8" y="10" width="6" height="5" fill="#87CEEB" />
      <rect x="17" y="10" width="6" height="5" fill="#87CEEB" />
      <rect x="26" y="10" width="6" height="5" fill="#87CEEB" />
      <rect x="8" y="19" width="6" height="5" fill="#87CEEB" />
      <rect x="26" y="19" width="6" height="5" fill="#87CEEB" />
    </svg>
  ),
  largeHouse: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#7CCD7C" />
      <rect x="4" y="4" width="32" height="32" rx="1" fill="#8B4513" stroke="#6B3410" strokeWidth="1" />
      <rect x="6" y="6" width="14" height="14" rx="1" fill="#A0522D" />
      <rect x="22" y="6" width="12" height="30" rx="1" fill="#A0522D" />
      <rect x="6" y="22" width="14" height="12" rx="1" fill="#A0522D" />
      <rect x="16" y="28" width="6" height="8" fill="#5C3317" />
      <rect x="8" y="9" width="4" height="4" fill="#87CEEB" />
      <rect x="24" y="9" width="4" height="4" fill="#87CEEB" />
      <rect x="24" y="24" width="4" height="4" fill="#87CEEB" />
      <rect x="8" y="24" width="4" height="4" fill="#87CEEB" />
    </svg>
  ),
  shed: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#7CCD7C" />
      <rect x="12" y="12" width="16" height="18" rx="1" fill="#A0522D" stroke="#8B4513" strokeWidth="1" />
      <rect x="17" y="20" width="6" height="10" fill="#6B3410" />
      <circle cx="21.5" cy="25" r="1" fill="#DAA520" />
    </svg>
  ),
  garage: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#B0B0B0" />
      <rect x="8" y="8" width="24" height="24" rx="1" fill="#808080" stroke="#696969" strokeWidth="1" />
      <rect x="11" y="20" width="18" height="12" rx="1" fill="#A9A9A9" />
      <line x1="11" y1="23" x2="29" y2="23" stroke="#696969" strokeWidth="0.5" />
      <line x1="11" y1="26" x2="29" y2="26" stroke="#696969" strokeWidth="0.5" />
      <line x1="11" y1="29" x2="29" y2="29" stroke="#696969" strokeWidth="0.5" />
    </svg>
  ),
  barn: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#7CCD7C" />
      <rect x="6" y="8" width="28" height="26" rx="1" fill="#8B0000" stroke="#6B0000" strokeWidth="1" />
      <line x1="20" y1="8" x2="20" y2="34" stroke="#FFF" strokeWidth="1" />
      <line x1="6" y1="21" x2="34" y2="21" stroke="#FFF" strokeWidth="1" />
      <rect x="15" y="24" width="10" height="10" fill="#5C1010" />
      <line x1="20" y1="24" x2="20" y2="34" stroke="#FFF" strokeWidth="0.5" />
    </svg>
  ),
  workshop: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#B0B0B0" />
      <rect x="8" y="8" width="24" height="26" rx="1" fill="#556B2F" stroke="#3B4B1F" strokeWidth="1" />
      <rect x="11" y="24" width="8" height="10" fill="#3B4B1F" />
      <rect x="22" y="12" width="8" height="6" fill="#87CEEB" />
      <rect x="10" y="12" width="8" height="6" fill="#87CEEB" />
    </svg>
  ),
  greenhouse: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#7CCD7C" />
      <rect x="10" y="8" width="20" height="26" rx="1" fill="#98FB98" fillOpacity="0.5" stroke="#228B22" strokeWidth="1" />
      <line x1="20" y1="8" x2="20" y2="34" stroke="#228B22" strokeWidth="0.5" />
      <line x1="10" y1="15" x2="30" y2="15" stroke="#228B22" strokeWidth="0.5" />
      <line x1="10" y1="22" x2="30" y2="22" stroke="#228B22" strokeWidth="0.5" />
      <line x1="10" y1="29" x2="30" y2="29" stroke="#228B22" strokeWidth="0.5" />
      <circle cx="15" cy="18" r="2" fill="#32CD32" />
      <circle cx="25" cy="25" r="2" fill="#32CD32" />
      <circle cx="15" cy="31" r="1.5" fill="#32CD32" />
    </svg>
  ),
  gazebo: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#7CCD7C" />
      <polygon points="20,6 8,14 8,32 32,32 32,14" fill="none" stroke="#DEB887" strokeWidth="1.5" />
      <circle cx="20" cy="20" r="10" fill="none" stroke="#DEB887" strokeWidth="1" strokeDasharray="3 2" />
      <circle cx="20" cy="20" r="2" fill="#DEB887" />
      <line x1="20" y1="6" x2="20" y2="32" stroke="#DEB887" strokeWidth="0.5" />
      <line x1="8" y1="20" x2="32" y2="20" stroke="#DEB887" strokeWidth="0.5" />
    </svg>
  ),
  carport: (
    <svg viewBox="0 0 40 40" className="w-10 h-10">
      <rect x="2" y="2" width="36" height="36" rx="2" fill="#B0B0B0" />
      <rect x="10" y="6" width="20" height="28" rx="1" fill="none" stroke="#696969" strokeWidth="1.5" strokeDasharray="4 2" />
      <rect x="10" y="6" width="20" height="4" fill="#696969" />
      <rect x="10" y="30" width="20" height="4" fill="#696969" />
      <rect x="14" y="14" width="12" height="16" rx="2" fill="#4682B4" fillOpacity="0.6" />
      <rect x="16" y="14" width="8" height="6" rx="1" fill="#87CEEB" fillOpacity="0.5" />
    </svg>
  ),
}
